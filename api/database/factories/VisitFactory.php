...
class VisitFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $mh__others = 						$this->faker->randomElement(['y', null]);
        $ns__other = 						$this->faker->randomElement(['y', null]);
        $ms__other = 						$this->faker->randomElement(['y', null]);
        $nd__other = 						$this->faker->randomElement(['y', null]);
        $nt__planted_objectives__other = 	$this->faker->randomElement(['y', null]);
        $nti__son__other = 					$this->faker->randomElement(['y', null]);
        $nti__en__other = 					$this->faker->randomElement(['y', null]);
        ...
        return [
            ...
            'inclusion_q1' => $this->faker->randomElement(['y', null]),
            'inclusion_q2' => $this->faker->randomElement(['y', null]),
            'inclusion_q3' => $this->faker->randomElement(['y', null]),
            // Criterios de exclusión
            'exclusion_q1' => $this->faker->randomElement(['y', null]),
            'exclusion_q2' => $this->faker->randomElement(['y', null]),
            'exclusion_q3' => $this->faker->randomElement(['y', null]),
            'exclusion_q4' => $this->faker->randomElement(['y', null]),
            'exclusion_q5' => $this->faker->randomElement(['y', null]),
            // Datos sociodemográficos
            'birth_date' => $this->faker->date(),
            // Antecedentes médicos
            'mh__diabetes' => $this->faker->randomElement(['y', null]),
            'mh__epoc' => $this->faker->randomElement(['y', null]),
            'mh__heart_failure' => $this->faker->randomElement(['y', null]),
            'mh__cancer' => $this->faker->randomElement(['y', null]),
            'mh__neurological_disease' => $this->faker->randomElement(['y', null]),
            'mh__liver_diseases' => $this->faker->randomElement(['y', null]),
            'mh__inflammatory_bowel_disease' => $this->faker->randomElement(['y', null]),
            'mh__renal_failure' => $this->faker->randomElement(['y', null]),
            'mh__other_chronic_diseases' => $this->faker->randomElement(['y', null]),
            'mh__others' => $mh__others,
            'mh__others_description' => $mh__others ? $this->faker->text() : '',
            // Ámbito asistencial
            'valuation_date' => $this->faker->date(),
            'hospitalization' => $this->faker->randomElement(['y', null]),
            'hospitalization_reason' => $this->faker->text(),
            'scheduled_visit' => $this->faker->randomElement(['y', null]),
            ...
            // Cribado nutricional
            'ns__must' => $this->faker->randomElement(['y', null]),
            'ns__nrs_2002' => $this->faker->randomElement(['y', null]),
            'ns__mna_sf' => $this->faker->randomElement(['y', null]),
            'ns__mis' => $this->faker->randomElement(['y', null]),
            'ns__snaq' => $this->faker->randomElement(['y', null]),
            'ns__conut' => $this->faker->randomElement(['y', null]),
            'ns__other' => $ns__other,
            'ns__other_description' => $ns__other ? $this->faker->text() : '',
            'ns__result' => $this->faker->randomElement(['y', null]),
            // Cribado muscular
            'ms__sarc_f' => $this->faker->randomElement(['y', null]),
            'ms__other' => $ms__other,
            'ms__other_description' => $ms__other ? $this->faker->text() : '',
            'ms__result' => $this->faker->randomElement(['y', null]),
            // Diagnóstico nutricional utilizado
            'nd__glim' => $this->faker->randomElement(['y', null]),
            'nd__mna' => $this->faker->randomElement(['y', null]),
            'nd__vgs' => $this->faker->randomElement(['y', null]),
            'nd__other' => $nd__other,
            ...
            'dynamometry__not_possible' => $this->faker->randomElement(['y', null]),
            'test_chair_five_repetitions' => $this->faker->numberBetween(0, 60),
            'test_chair__not_possible' => $this->faker->randomElement(['y', null]),
            ...
            'mar__normal' => $this->faker->randomElement(['y', null]),
            // Tratamiento nutricional
            // Objetivo/s planteado/s (puede indicarse más de uno si en su opinión aplica)
            'nt__planted_objectives__weight_gain' => $this->faker->randomElement(['y', null]),
            'nt__planted_objectives__muscle_gain' => $this->faker->randomElement(['y', null]),
            'nt__planted_objectives__preservation_status' => $this->faker->randomElement(['y', null]),
            ...
            'nt__start' => $this->faker->randomElement(['y', null]),
            'nt__specify' => $this->faker->text,
            // Tipo de tratamiento nutricional indicado
            'nti__parental_nutrition' => $this->faker->randomElement(['y', null]),
            'nti__dietary_modifications' => $this->faker->randomElement(['y', null]),
            'nti__son' => $this->faker->randomElement(['y', null]),
            'nti__son__hc_with_smi' => $this->faker->randomElement(['y', null]),
            'nti__son__hc_without_smi' => $this->faker->randomElement(['y', null]),
            'nti__son__nc_without_smi' => $this->faker->randomElement(['y', null]),
            'nti__son__diabetics_hypercaloric' => $this->faker->randomElement(['y', null]),
            'nti__son__normal_normoprotein_without_msi' => $this->faker->randomElement(['y', null]),
            'nti__son__peptide_formulas' => $this->faker->randomElement(['y', null]),
            'nti__son__snp' => $this->faker->randomElement(['y', null]),
            'nti__son__other' => $nti__son__other,
            'nti__son__other_description' => $nti__son__other ? $this->faker->text : '',
            'nti__en' => $this->faker->randomElement(['y', null]),
            'nti__en__hypercaloric_with_msi' => $this->faker->randomElement(['y', null]),
            'nti__en__hypercaloric_without_msi' => $this->faker->randomElement(['y', null]),
            'nti__en__caloric_without_msi' => $this->faker->randomElement(['y', null]),
            'nti__en__specific_diabetics_with_smi' => $this->faker->randomElement(['y', null]),
            'nti__en__normal_calorie_without_smi' => $this->faker->randomElement(['y', null]),
            'nti__en__peptide_formulas' => $this->faker->randomElement(['y', null]),
            'nti__en__snp' => $this->faker->randomElement(['y', null]),
            'nti__en__other' => $nti__en__other,
            ...
            'refers_patient_to_begin_nutritional_treatment' => $this->faker->randomElement(['y', null]),
            // ¿El paciente ha seguido la recomendación nutricional prescrita?
            'nt__pnr' => $this->faker->randomElement(['y', null]),
            ...
            'nt__objective_reached' => $this->faker->randomElement(['y', null]),
            ...
            'nt__improvement' => $this->faker->randomElement(['y', null]),
            'nt__has_not_got_improvement_reason' => $this->faker->text,
            // Actividad física, promoción
            'pa__prescribed' => $this->faker->randomElement(['y', null]),
            'pa__prescribed_reasons' => $this->faker->text,
            'pa__aerobic_predominance' => $this->faker->randomElement(['y', null]),
            'pa__predominance_muscular_strength' => $this->faker->randomElement(['y', null]),
            'pa__mixed' => $this->faker->randomElement(['y', null]),
            // ¿El paciente ha seguido la recomendación de actividad física prescrita?
            'pa__hpftppar' => $this->faker->randomElement(['y', null]),
