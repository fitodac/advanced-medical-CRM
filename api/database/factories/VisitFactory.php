...
class VisitFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'nti__en__caloric_without_msi' => $this->faker->randomElement(['y', 'n', null]),
            'nti__en__specific_diabetics_with_smi' => $this->faker->randomElement(['y', 'n', null]),
            'nti__en__normal_calorie_without_smi' => $this->faker->randomElement(['y', 'n', null]),
            'nti__en__peptide_formulas' => $this->faker->randomElement(['y', 'n', null]),
            'nti__en__snp' => $this->faker->randomElement(['y', 'n', null]),
